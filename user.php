    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <button class="btn " data-bs-toggle="modal" data-bs-target="#ModalTambahUser" style="background-color:rgb(216, 191, 216)">Tambah User</button>
                </div>
            </div>
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_user.php" method="POST">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="input_user_validate" value="12345">Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_edit_user.php" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <input <?php echo ($row['username'] == $_SESSION['username_tabungku']) ? 'disabled' : ''; ?> type="email" class="form-control" id="floatingInput" placeholder="name@example.com" name="username" required value="<?php echo $row['username'] ?>">
                                                <label for="floatingInput">Username</label>
                                                <div class="invalid-feedback">
                                                    Masukkan Username.
                                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_delete_user.php" method="POST">
                                    ...
                                    <div class="col-lg-12">
                                        <?php
                                        if ($row['username'] == $_SESSION['username_tabungku']) {
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-danger" name="delete_user_validate" value="12345" <?php echo ($row['username'] == $_SESSION['username_tabungku']) ? 'disabled' : ''; ?>>Hapus</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_reset_password.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-success" name="reset_password_validate" value="12345" <?php echo ($row['username'] == $_SESSION['username_tabungku']) ? 'disabled' : ''; ?>>Reset Password</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <button style="background-color:rgb(138, 205, 215)" class="btn btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ModalView<?php echo $row['id'] ?>"><i class="bi bi-eye"></i></button>
                                        <button style="background-color:rgb(247, 183, 135)" class="btn btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ModalEdit<?php echo $row['id'] ?>"><i class="bi bi-pencil-square"></i></button>
